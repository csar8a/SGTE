<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="VerCursoTaller.aspx.cs" Inherits="SGTE_v1._0.VerCursoTaller" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Ver Taller
            </h1>
            <%--<ol class="breadcrumb">
                <li>
